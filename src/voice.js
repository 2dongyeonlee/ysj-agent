...
const MEETING_JSON_SYSTEM = PERSONA_STYLE + "\n\n" +
  ...
  "■ <b>안건</b>\n" +
  "• <b>안건명</b>\n" +
  "  내용: 핵심 논의·배경·쟁점 2~3줄(숫자·고유명사 포함, 인명·직책은 <b>굵게</b>)\n" +
  "  → <u>결정: 확정된 것</u>  또는  → 미결: 남은 것\n\n" +
  "■ <b>후속조치</b>\n" +
  "• <b>담당자</b>: 할 일 / <u>기한·시점</u> (담당/기한 있는 액션만. 없으면 '없음')\n" +
  "─────\n" +
  "전체 회의록 필요 시 /minutes\n\n" +
  ...
  "- 강조는 short와 동일: 인명·직책은 <b>, 결정·기한·금액은 <u>. 안건명은 '• <b>안건명</b>' 블릿 형식. 들여쓰기 공백 대신 블릿(•)을 쓴다.\n" +
